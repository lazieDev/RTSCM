<%-- 
    Document   : satellite
    Created on : Feb 12, 2018, 4:23:49 PM
    Author     : Sakir
--%>
...
<html>
    ...
    <body>
        <center class="header">
            ...
            <hr>
            <form>
            <input type="submit" value="Satellite Details" onclick="this.form.action='sdetails.jsp';" />
            </form>
...
<%
    ...
    String sql = "pragma table_info(satellite)";
